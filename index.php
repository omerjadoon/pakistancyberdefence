...
<footer>
    <h6 style="color:#fff; text-align: center;padding: 18px; background: rgba(0,255,0,0.3); margin-top: 80px">Developed by Omer Khan Jadoon (Co-Founder Jadoon Technologies)</h6>
</footer>
